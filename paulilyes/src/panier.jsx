            ...
            <div class="container mx-auto mt-10">
                <div class="flex shadow-md my-10">
                    ...
                    <div id="summary" class="w-1/4 px-8 py-10">
                        <h1 class="font-semibold text-2xl border-b pb-8">Récap Commande</h1>
                        <div class="flex justify-between mt-10 mb-5">
                            <span class="font-semibold text-sm uppercase">Articles</span>
                            <span class="font-semibold text-sm">{getTotalPrix()}€</span>
                        </div>
                        <div>
                            <label class="font-medium inline-block mb-3 text-sm uppercase">Livraison</label>
                            <select class="block p-2 text-gray-600 w-full text-sm">
                                <option>Livraison classique - 10.00€</option>
                            </select>
                        </div>
                        <div class="py-10">
                            <label for="promo" class="font-semibold inline-block mb-3 text-sm uppercase">Code Promo</label>
                            <input type="text" id="promo" placeholder="Entrez votre code" class="p-2 text-sm w-full" />
                        </div>
                        <button class="bg-red-500 hover:bg-red-600 px-5 py-2 text-sm text-white uppercase">Appliquer</button>
